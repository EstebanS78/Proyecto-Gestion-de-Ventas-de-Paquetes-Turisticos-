...
public class VentaIT {
    ...
    /**
     * Test of listarArray method, of class Venta.
     */
    @Test
    public void testListarArray() {
        System.out.println("listarArray");
        Venta instance = null;
        String expResult = "";
        String result = instance.listarArray();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
    ...
    public void testCalcularValorTotalDescuento() {
        ...
        Venta instance = null;
        int expResult = 0;
        int result = instance.calcularValorTotalDescuento();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
